...
{
    public class Webcam2Fragment : Android.Support.V4.App.Fragment
    {
        ...
        {
            this.index = 2;
            View rootView = inflater.Inflate(Resource.Layout.Webcam2, container, false);

            var snapshot = rootView.FindViewById<ImageView>(Resource.Id.webcam2);
        ...
        {
            ImageView image = this.Activity.FindViewById<ImageView>(Resource.Id.webcam2);
